...
#[embassy_executor::task]
async fn setup_wifi (ssid: String<32>, password: String<64>, mut wifi: EspWifi<'static>) { //static extends lifetime - compiler complains
     //Wifi configuration
    ...
    esp_println::println!("Cfonnected"); //boilerplate for checking connection
